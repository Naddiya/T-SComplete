...
const Profile = (
    ...
    console.log(store.getState().projectsUser)
            ...
            <div className="select">
                <div className="select-left">
                    <div className="select-left-picture">
                        ...
                        <img src='https://avatars.dicebear.com/api/male/dave.svg?mood[]=happy' alt='bill murray photograph' />
                    </div>
                ...
                <div className="select-right">
                    ...
                    <div className="select-right-container">
                        ...
                        <Item.Group divided>
                            {store.getState().projectsUser.map((project) => (
                                <Projects isPersonal={true} key={project.title} {...project} />
                            ))}
                        </Item.Group>
