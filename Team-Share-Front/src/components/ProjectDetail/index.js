...
class ProjectDetail extends React.Component {
  ...
  handleRequestSubmit = () => {
    axios.post('http://95.142.160.243/team-share-back/public/request/new', this.state.data)
      .then((response) => {
  ...
  componentDidMount() {
    ...
    axios.get(`http://95.142.160.243/team-share-back/public/project/${params.id}`)
      .then((response) => {
